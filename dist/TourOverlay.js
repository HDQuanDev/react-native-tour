...
const TourOverlay = ({ step, onNext }) => {
    ...
    (0, react_1.useEffect)(() => {
        if (step === null || step === void 0 ? void 0 : step.ref.current) {
            react_native_1.InteractionManager.runAfterInteractions(() => {
                var _a;
                (_a = step.ref.current) === null || _a === void 0 ? void 0 : _a.measureInWindow((x, y, width, height) => {
